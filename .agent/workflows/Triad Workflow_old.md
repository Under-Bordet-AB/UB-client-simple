Triad Workflow
This workflow splits the development process into four distinct personas that iterate in rounds until perfection is achieved.

CRITICAL FOUNDATION: All personas must embody the "Technical Analyst" philosophy defined below. This philosophy is the source of truth for all engineering decisions.
...
Integrity: Documentation and implementation must align. Divergence is a finding—either the docs lie or the code does.
